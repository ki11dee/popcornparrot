...
## 사례 1: 권력이란 무엇인가?
- "권력이란 무엇인가" 라는 질문도 정확히 저 "자유의지가 있다/없다" 수준의 조잡한 질문임
...
- 히트 치는 음악들은 초 단위 트랙으로 분석했을 때 아무런 공통점이 안 보이고 그냥 랜덤한 리듬들의 조합밖에 안 됨. 정확히 어떤 규칙으로 특정 리듬들의 조합이 하모니가 되거나 되지 않게 되는 걸까? 그리고 그 수많은 종류의 하모니들 중 왜 어떤 것들은 대중들 사이에서 히트를 쳐서 마치 임계점에 도달해서 물질이 상전이 일으키는 것마냥 전염되고 왜 어떤 것들은 안 그런 걸까?
    - 물리 법칙만 생각하면 microstate는 예측불가능해도 macrostate는 일관된 법칙을 반드시 따른다고 생각됨
    - 인간 사회에서도 (설령 그 법칙이 어마어마한 복잡도를 가질지라도) 이 모든 현상들이 '자유의지'라든지 '우연, 천운'이라든지 같은 단어들로 퉁쳐지고 말기엔 서로 너무나 비슷한 구조를 가지고 있음
...
- 갑자기 탈북민 얘기를 왜 두 번째 사례로 가져오냐 싶을 수 있는데, 읽고 나면 이게 왜 서로 연결되는 이야기인지 볼 수 있음
    ...
    - 내 생각: '자유'는 근대 이후 사회에서 제도적으로 분명히 정의 가능하고, B의 시각은 그나마 그것에 가까워 보이긴 함. 근데 이것도 푸코 이후 현대 학계에선 다 구식 됨.
        ...
        - \<A가 B보다 더 자유롭다\>라고 말하려면 자유란 개념이 정확히 무엇이며 그것의 조건이 무엇이고 자유가 언제 어떻게 발현되는지 알아야 함, 그게 QFT에서 스케일 나눠서 cutoff로 날려버리듯이, 아님 확률론에서 데이터를 outlier 취급하듯이 걍 없는 셈 치는 걸까? 근데 그러기엔 뭔가 인간 한 명 한 명이 특정 사회에 살면서 마치 자유를 '체감'하는 게 있는 것처럼 보인단 문제가 있다.
            - (2)+(3)은 없지만 (1)의 deviation이 매우 큰 북한 사람이 남한보다 북한을 더 자유롭다고 느끼고, (2)+(3)이 있음에도 (1)의 deviation이 매우 작은 남한 사람들이 인생을 자유롭다고 느끼지 않는 것일 수 있음. 제도적 자유가 존재하지 않는 사회와 고도의 경쟁 사회 중 어느 사회가 더 자유로운지를 말하는 것이 생각보다 쉽지 않을 수 있음. 그러나 이는 자유를 규범 개념으로만 취급할 것인가 아닌가의 문제일 수도 있음. 이 경우, "자유가 실재하지만 행사되지는 않는 사회를 자유롭다고 부를 것인가?" 라는 질문에 대한 답변은 "그렇다. 부른다." 가 됨. 즉 자유를 (2)+(3)으로만 본다면: \<제도적으로 보장된 권리의 집합 + 형식적인 선택 가능성\>이라고 본다면
...
- 자유를 제도로 가지는 사회 안의 개인이 어떻게 자유를 체감하지 못하는 것일까? 아무것도 규제하지 않고, 금지하지 않고, 강제하지 않았는데도 왜 사람들의 선택 궤적이 '사실상' 결정되는가?
    - 이 결과는 당연한 것일 수 있음.
        - 누구나 자유롭게 선택할 수 있지만, '실제로' 하는 선택은 대부분 정해져 있음.
        - 자유가 사라진 게 아니라 인센티브가 된 것임. 즉 자유를 행사하는 비용이 높아지는 것임
        - 실제 사회에서는 자유의 형식적 보유자와 실질적 행사자가 체계적으로 분리될 수 있음. 왜냐면 인간이 '자유'를 체감할 때 실제로 느끼는 건 규범적 의미의 자유가 아니라 최적화 문제 자체가 정의 안 되어 있거나 외압이 부재하거나 인지 부하가 낮은 것을 느끼는 것임. 이 감각은 freedom과도, liberty와도 별 관련이 없음. 그렇다고 이렇게 인간이 느끼는 자유로음의 감정이 허상인 것은 아님. 비유하자면 온도가 microstate에서 관측 자체가 안 되는데도 상전이의 가장 민감한 파라미터 중 하나인 것과 같음
        - 왜 자유를 정의할 때 규범 개념 외의 '체감 상의 자유'를 굳이 따지는가: 그렇지 않으면 사회 전체에서 심리 편향이 나타나는 이유를 설명할 수 없음. 
- 자유는 measure zero-like한가? 절대 관측 안 되지만 그게 물리적으로 불가능한 사건은 아닌 것과 같은 걸까? 자유는 chaotic할까? 시스템은 결정론적인데 예측불가능한 상황에 가까운 걸까? 아님 양자역학의 터널링 효과가 barrier 조건 따라서 달라지는 것과 비슷한 것일까? 아님 spin glass의 ergodicity breaking 같은 것일까?
...
- 선택지 자체는 많은데 실제로 사람들이 하는 선택들은 정해져 있다면, 형식적 자유는 있는데 실질적 자유가 없단 소리임. 하지만 진정한 의미의 자유는 둘 모두의 capacity를 만족해야 함
    ...
    - 게임이론 비유: agent들이 전략을 자유롭게 선택은 하는데, 이미 payoff landscape의 geometry가 디자인돼 있어서 agent들이 실제로 방문하는 상태가 거의 결정돼 있고, 내쉬 균형은 존재하는데 거기에 도달하는 모든 경로들이 사실상 비슷하다는 것임. 현대 사회에서는 폭력도 검열도 없는데도 불구하고 개별 인간들이 스스로 선택의 자유를 제한하는 것처럼 보이는 현상이 발생. 경쟁 사회에서 개인이 자유를 체감하기는 힘들어 보임. 
