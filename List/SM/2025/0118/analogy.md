...
자연현상을 기술하는 물리학은 자연철학을 계승한 학문입니다. 물리학에서 사용되는 수식에는 항상 참이라고 가정하는 정의나 관계를 기술하는 항등식과 특정 조건에서 성립하여 현상에 대해 구체적인 해를 계산하는 방정식이 있습니다. 두 수식에서 사용되는 등호의 의미는 다르며, 항등식과 방정식을 이루는 기호들은 미묘한 인과관계의 순서에 따라 배열되는 경향이 있습니다. 예를 들어 뉴턴의 제2법칙 $$F=ma$$ 과 슈뢰딩거 방정식 $$i\hbar \frac{\partial}{\partial t}\Psi(\mathbf{r},t)$$ $$=H\Psi(\mathbf{r},t)$$에서의 등호의 의미는 다르게 해석되어야 하며, $$F=ma$$가 $$\frac{F}{m}=a$$라고 쓰여지는 경우는 교육적인 목적(혹은 그 외의 의도)으로 설명되는 상황 외에는 거의 없습니다.  
