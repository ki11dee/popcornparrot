...
자연현상을 기술하는 물리학은 자연철학을 계승한 학문입니다. 물리학에서 사용되는 수식에는 항상 참이라고 가정하는 정의나 관계를 기술하는 항등식과 특정 조건에서 성립하여 현상에 대해 구체적인 해를 계산하는 방정식이 있습니다. 두 수식에서 사용되는 등호의 의미는 다르며, 방정식을 이루는 기호들은 미묘한 인과관계의 순서에 따라 배열되는 경향이 있습니다.
